...
public class ConcurrentModule extends HandlerModule {

    @Override
    protected void configureHandlers() {
        install(new FactoryModuleBuilder().build(ConcurrentChannelFactory.class));

        bind(ConcurrentHandler.class).in(Singleton.class);
