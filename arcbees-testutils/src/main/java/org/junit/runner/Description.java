...
public class Description implements Serializable {
     ...
     * than {@link #createTestDescription(Class, String, java.lang.annotation.Annotation...)} for test runners whose test cases are not
    ...
    // BEGIN MODIFICATION
    public void setfTestClass(Class<?> fTestClass) {
